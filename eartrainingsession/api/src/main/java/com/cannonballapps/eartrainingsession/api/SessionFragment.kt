...
import com.cannonballapps.eartrainingsession.api.databinding.FragmentSessionBinding
import com.cannonballapps.musictheory.musicutilities.Note
import com.cannonballapps.shared.data.SessionType
import com.cannonballapps.shared.models.MidiPlayer2
    ...
    private fun setupStatusMessageForListening() {
        binding.sessionStatusMessageTv.apply {
            ...
            viewModel.curPitchDetectedAsMidiNumber.observe(viewLifecycleOwner) { midiNum ->
                // TODO: refactor
                val noteStr = if (midiNum == null) "..." else Note(
                    midiNum
                ).toString()
                text = noteStr
            }
