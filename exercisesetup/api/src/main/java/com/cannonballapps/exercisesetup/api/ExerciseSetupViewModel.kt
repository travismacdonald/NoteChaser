...
class ExerciseSetupViewModel @Inject constructor(
    private val prefsStore: com.cannonballapps.shared.prefsstore.PrefsStore
) : ViewModel() {

    lateinit var exerciseType: com.cannonballapps.shared.data.ExerciseType
    ...
    fun saveSessionType(sessionType: com.cannonballapps.shared.data.SessionType) {
        viewModelScope.launch {
