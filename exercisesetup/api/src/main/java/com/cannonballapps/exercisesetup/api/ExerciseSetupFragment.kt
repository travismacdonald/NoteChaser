package com.cannonballapps.exercisesetup.api
...
import com.cannonballapps.exercisesetup.api.databinding.FragmentExerciseSetupBinding
...
import com.cannonballapps.musictheory.musicutilities.ParentScale2
...
//        viewModel.exerciseType = args.exerciseType
    ...
    private fun bindSessionTypeSingleList() {
        val sessionTypeNames = com.cannonballapps.shared.data.SessionType.values().map { it.toString() }.toTypedArray()
        ...
        binding.sessionTypeSingleList.apply {
            ...
            layout.setOnClickListener {
                showMaterialDialogSingleList(
                    ...
                    onPositiveButtonClick = { selectedIx ->
                        val selectedSessionType = com.cannonballapps.shared.data.SessionType.values()[selectedIx]
    ...
    private fun bindNumQuestionsSlider() {
        binding.numQuestionsSlider.apply {
            ...
            viewModel.sessionType.observe(viewLifecycleOwner) { type ->
                layout.isVisible = type == com.cannonballapps.shared.data.SessionType.QUESTION_LIMIT
            }
    ...
    private fun bindTimerLengthSlider() {
        binding.sessionTimeLimitSlider.apply {
            ...
            viewModel.sessionType.observe(viewLifecycleOwner) { type ->
                layout.isVisible = type == com.cannonballapps.shared.data.SessionType.TIME_LIMIT
            }
